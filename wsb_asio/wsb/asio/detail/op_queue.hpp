#ifndef WSB_ASIO_DETAIL_OP_QUEUE_HPP
#define WSB_ASIO_DETAIL_OP_QUEUE_HPP
...
public:
    template <typename Operatioon>
    static Operatioon* next(Operatioon* o) { return static_cast<Operatioon*>(o->next_); }

    template <typename Operation1, typename Operation2>
    static void next(Operation1*& o1, Operation2* o2) { o1->next_ = o2; }

    template <typename Operation>
    static void destroy(Operation* o) { o->destroy(); }

    template <typename Operation>
    static Operation*& front(op_queue<Operation>& q) { return q.front_; }

    template <typename Operation>
    static Operation*& back(op_queue<Operation>& q) { return q.back_; }
};
...
public:
    ...
    void pop()
    {
        if (front_) {
            ...
            front_ = op_queue_access::next(tmp);
            if (front_ == 0)
                back_ = 0;
    ...
    {
        return op_queue_access::next(o) != 0 || front_ == o;
    }
